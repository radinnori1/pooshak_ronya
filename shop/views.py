...
from pyment.forms import ShippingForm
from pyment.models import ShippingAddress, Order, OrderItem
...
def search(request):
    if request.method=='POST':
        ...
        if not searched:
            messages.success(request, 'محصول شما پیدا نشد')
    ...
    return render(request, 'search.html', {'items':searched})
